            ...
            <Grid className="contact-grid">
              <Cell col={6}>
                ...
                <img           
                            ...
                            />
                 <p style={{ width: '75%', margin: 'auto', paddingTop: '1em'}}>I am a Computer Science Engineer, I am a freelancer with expertise in Full Stack Web Development, along with Machine Learning and Ai.</p>
